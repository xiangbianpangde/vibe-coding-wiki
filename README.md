...
<p align="center">
  ...
  <a href="https://xiangbianpangde.github.io/vibe-coding-wiki/sitemap.xml"><img src="https://img.shields.io/badge/sitemap-197%20URLs-blue" alt="Sitemap"></a>
...
- 📚 **189 terms** organized into **8 layers**:
...
- 🌐 **Bilingual** — 189/189 terms translated to English; one-click language switch
...
- **Search 189 terms** → press `⌘K` from any page
...
```
189 terms → 8 layer JSON files → terms-loader.js (async fetch)
                          ↓
...
- ✅ 189 terms, 8 layers, 14 scenarios
- ✅ Bilingual (zh-CN ↔ en)
...
**v2.2 · 2026-08-17 · 189 terms · 8 layers · 14 scenarios · 100% bilingual**
