...
const OG_IMAGE_ABS = 'https://xiangbianpangde.github.io/vibe-coding-wiki/og-image.svg';
const OG_IMAGE_ALT_REL = '../og-image.svg';   // from /pages/*.html
const OG_IMAGE_ALT_ABS = 'https://xiangbianpangde.github.io/vibe-coding-wiki/og-image.svg';
